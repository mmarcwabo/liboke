...
class Database extends PDO
{
    ...
    public function update_phones($old_phone_number, $new_phone_number)
    {
        try {
            //code...
            $sql_update_query = "UPDATE teacher SET phonenumber = ? WHERE phonenumber = ?";
            $sth = $this->prepare($sql_update_query);
            $sth->execute(array($new_phone_number, $old_phone_number));
        } catch (\Throwable $th) {
