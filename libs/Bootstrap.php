...
class Bootstrap
{
    ...
    private function _error()
    {
        ...
        $this->_controller = new Logis_Error();
        $this->_controller->index();
        exit;
    }
    /**
     * See https://github.com/bepsvpt/secure-headers
     */

    private function _secure_headers()
    {
        $secureHeaders = SecureHeaders::fromFile(_LIBS_ . 'SecureHeaders.php');
        // Get headers
